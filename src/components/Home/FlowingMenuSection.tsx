...
const FlowingMenu: React.FC<FlowingMenuSectionProps> = ({ items = [] }) => {
  return (
...
export function FlowingMenuSection({ items }: FlowingMenuSectionProps) {
  return (
    <section className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 animate-fadeIn">
          <h2 className="text-2xl md:text-3xl font-light text-white mb-3">Our Collections</h2>
          <p className="text-gray-300 max-w-2xl mx-auto">Hover over collections for a flowing preview of styles</p>
        </div>
